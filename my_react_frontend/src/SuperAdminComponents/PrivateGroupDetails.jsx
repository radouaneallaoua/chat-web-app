...
import EditPrivateGroupIntern from "./EditPrivateGroupIntern ";

function PrivateGroupDetails(props) {
    ...
    const handleClick = () => {
        setClickOnPrivateItem(clickOnPrivateItem);
    ...
    let clickedGroup = user.role === 1 ? props.privateGroups.find(group => group.id === clickOnPrivateItem)
    ...
    return <div className="container mt-3">
        <div className="row ">
            <div className="col-md-10 mx-auto " style={{ backgroundColor: "#9E9588", borderRadius: "20px" }}>
                <div className="row">
                    <div className="col-md-1">
                        <img src={back} onClick={handleClick} width={40} className="float-start mt-3 " onMouseOver={e=>handleMouseOver(e)} onMouseLeave={e=>handleMouseLeave(e)} style={{cursor:'pointer'}} />
                    </div>
                ...
                {user.role !== 1 && user.role !== 2 ? null :
                    editGroup ? <EditPrivateGroupIntern />
                        : null
                }
                { user.role!==1 && user.role!==2?null:
                    addMembersToGroup ? <AddMembers groupId={clickOnPrivateItem} />
                        : null
                }
                {
                    displayMembersIsClicked ? <DisplayGroupMembers groupId={clickOnPrivateItem} />
                        :null
                }
            </div>
