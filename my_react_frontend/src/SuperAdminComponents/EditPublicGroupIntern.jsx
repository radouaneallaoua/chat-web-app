...
import { clickOnPublicItemContext, userContext } from "../App";



function EditPublicGroupIntern() {
    const [user, setUser] = useContext(userContext);
    const [name, setName] = useState("");
    const [image, setImage] = useState(null);
    const [feedBack, setFeedBack] = useState([]);
    const groupId = useContext(clickOnPublicItemContext)[0];
    const handleEdit = (e) => {
        e.preventDefault();
        ...
        fetch('http://localhost/again/controller/groupController.php?action=editPublicGroup', { method: 'POST', body: data })
            ...
            <form method="POST" onSubmit={(e) => handleEdit(e)} className="col-md-12 ">
                <div className="row mt-5">
                    ...
                    <div className="row col-md-3 offset-md-8 mt-3">
                        <button type="submit" className="btn btn-warning row mt-2 float-end" disabled={
...
export default EditPublicGroupIntern;